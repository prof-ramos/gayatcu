...
- **Network:** http://<seu-ip-local>:8501
  _(Nota: você pode descobrir seu IP local usando comandos como `ipconfig` no Windows ou `ip addr`/`ifconfig` no Linux/macOS)_
...
_Atualizado em 2026-03-08 21:23_
